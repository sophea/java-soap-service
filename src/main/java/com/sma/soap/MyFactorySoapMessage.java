...
public class MyFactorySoapMessage implements SoapMessageFactory, InitializingBean {
    // This is the Request Context Attribute.
    private static final String    REQUEST_CONTEXT_ATTRIBUTE = "MyFactorySoapMessage";

    private static final Log       LOG                    = LogFactory.getLog(MyFactorySoapMessage.class);
    ...
    // This Object, will be responsible for choosing the Protocol on Runtime, it can be application/xml or text/xml (SOAP 1.2 &
    // SOAP 1.1)
    ...
    public void setSoapVersion(SoapVersion version) {
        LOG.info("setSoapVersion called with: " + version + " -- ignoring");
    }
    ...
    public void setSoapProtocolChooser(SoapProtocolChooser soapProtocolChooser) {
        LOG.info("Setting out the SOAP Protocol Chooser");
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        LOG.info("Setting both the SOAP Version to 1.1 and 1.2");
    }
    ...
    public SoapMessage createWebServiceMessage(InputStream inputStream) throws IOException {
        ...
        if (mf == soap11MessageFactory) {
            LOG.info("Final soapMessageFactory? " + soap11MessageFactory);
        } else {
            LOG.info("Final soapMessageFactory? " + soap12MessageFactory);
        }
