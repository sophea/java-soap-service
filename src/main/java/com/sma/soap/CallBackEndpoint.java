...
import com.sma.jaxb.FailurePayment;
import com.sma.jaxb.FailurePaymentRequest;
import com.sma.jaxb.FailurePaymentResponse;

@Endpoint(value = javax.xml.ws.soap.SOAPBinding.SOAP12HTTP_BINDING)
